...
public class LivingFurnaceModel extends EntityModel<LivingFurnaceEntity> {
	private final ModelPart bb_main;
	public LivingFurnaceModel(ModelPart root) {
	...
	@Override
	public void setAngles(LivingFurnaceEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
