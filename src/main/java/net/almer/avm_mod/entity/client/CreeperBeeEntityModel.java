...
public class CreeperBeeEntityModel<T extends CreeperBeeEntity>
extends AnimalModel<T> {
    ...
    public CreeperBeeEntityModel(ModelPart root) {
    ...
    public void animateModel(T beeEntity, float f, float g, float h) {
        ...
        this.bodyPitch = ((CreeperBeeEntity)beeEntity).getBodyPitch(h);
    }
    @Override
